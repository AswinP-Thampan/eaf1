        ...
        <div>
            ...
            <div className='p-8 grid sm:grid-cols-1 xl:grid-cols-2 xl:grid-cols-[30%_max-content] justify-around items-center gap-4'>
                ...
                <div className='relative' style={{ position: 'relative', width: '100%', maxWidth: '1200px', margin: '0 auto' }}>
                    ...
                    <img className={`h-fit rounded-3xl w-full border-8 border-l-0 border-b-0 border-color-`} src={'/basic/b1.jpg'} alt="Main Image" />
                    <button data-tooltip-target="tooltip-animation" onClick={() => setType('Halo')} type="button" className={` ${buttonStyle} top-[24%] left-[55%]`} />
                    <button data-tooltip-target="tooltip-animation" onClick={() => setType('Engine Intake Top')} type="button" className={` ${buttonStyle} top-[18%] left-[61.75%]`} />
                    <button data-tooltip-target="tooltip-animation" onClick={() => setType('Engine Intake Side')} type="button" className={` ${buttonStyle} top-[38%] left-[40%]`} />
                    ...
                    <button data-tooltip-target="tooltip-animation" onClick={() => setType('Tyres')} type="button" className={` ${buttonStyle} top-[52%] left-[60%]`} />
