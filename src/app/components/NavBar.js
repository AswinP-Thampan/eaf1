...
<header className="relative flex flex-wrap md:justify-start md:flex-nowrap w-full bg-black text-sm py-3 font-F1R">
    ...
    <div className="flex items-center justify-between">
      <a className="flex-none text-xl text-site_text font-F1W " href="#" aria-label="Brand">
        eaf1
      </a>
    ...
    <div id="hs-navbar-example" className="hidden hs-collapse overflow-hidden transition-all duration-300 basis-full grow md:block" aria-labelledby="hs-navbar-example-collapse">
      <div className="flex flex-col gap-3 mt-5 md:flex-row md:items-center md:justify-end md:mt-0 md:ps-5">
        <a className="md:p-4 py-2 block text-white hover:text-site_text font-semibold" href="/">Home</a>
        <a className="md:p-4 py-2 block text-white hover:text-site_text font-semibold" href="/f1car">Know More</a>
        <a className="md:p-4 py-2 block text-white hover:text-site_text font-semibold" href="/mclaren">McLaren</a>
        <a className="md:p-4 py-2 block text-white hover:text-site_text font-semibold" href="#">Red Bull</a>
        <a className="md:p-4 py-2 block text-white hover:text-site_text font-semibold" href="/mercedes">Mercedes</a>
        <a className="md:p-4 py-2 block text-white hover:text-site_text font-semibold" href="#">Aston Martin</a>
        <a className="md:p-4 py-2 block text-white hover:text-site_text font-semibold" href="/ferrari">Ferrari</a>
      </div>
    </div>
  </nav>
</header>
